...
-- /___/   /\     Timestamp: Wed Mar 13 13:36:56 2019
-- \   \  /  \ 
--  \___\/\___\
--             
-- Command	: -intstyle ise -s 4 -pcf PROCESS_SYNC.pcf -rpw 100 -tpw 0 -ar Structure -tm PROCESS_SYNC -w -dir netgen/map -ofmt vhdl -sim PROCESS_SYNC_map.ncd LCELL_map.vhd 
-- Device	: 3s50atq144-4 (PRODUCTION 1.42 2013-10-13)
-- Input file	: PROCESS_SYNC_map.ncd
...
architecture Structure of PROCESS_SYNC is
  ...
  signal C_BUFGP_IBUFG_0 : STD_LOGIC; 
